(function () {
  ...
  function ensureWidgetStyles() {
    ...
    style.textContent = `
      body .agent-orb-button{position:fixed;top:16px;left:50%;right:auto;transform:translateX(-50%);z-index:9000;display:none;width:auto;min-width:0;min-height:50px;align-items:center;justify-content:flex-start;gap:10px;border:1px solid rgba(255,255,255,.62);border-radius:999px;padding:7px 12px 7px 7px;background:rgba(255,255,255,.92);color:#101827;box-shadow:0 18px 40px rgba(15,23,42,.18);cursor:pointer;font:inherit}
      ...
      body .agent-chat-panel{position:fixed;top:74px;left:50%;right:auto;transform:translateX(-50%);z-index:9001;display:none;width:min(390px,calc(100vw - 28px));border:1px solid var(--line,#dfe7e2);border-radius:14px;background:#fff;color:var(--text,#101827);box-shadow:0 22px 60px rgba(15,23,42,.22);overflow:hidden}
