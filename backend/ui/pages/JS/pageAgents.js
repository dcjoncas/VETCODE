(function () {
  const agents = [
    ...
    },
    {
      ...
      href: "find-candidate.html",
      color: "#b88727",
      specialty: "Cross-system AI scanning for hidden client, candidate, Atlas, People Data, GitHub, and news opportunities.",
    ...
    },
    {
      ...
      href: "call.html",
      color: "#2f7d4b",
      specialty: "Phone intake, call ask records, JD creation, caller profiles, and matching handoff.",
      canDo: ["Review call intake status", "Check saved Call Ask jobs and profiles", "Help connect phone intake to matching"],
    ...
    },
    {
      key: "prospects",
      name: "Numa",
      page: "Prospect Reference",
      href: "prospect-reference.html",
      color: "#0f766e",
      specialty: "Passive company reference search, prospect mining, and promotion into Atlas.",
      canDo: ["Find target accounts", "Compare legacy prospects", "Promote a useful prospect to Atlas"],
      prompt: "Owns the passive prospect universe. Keep raw references separate from Atlas until a user chooses to promote a company into active relationship work.",
    },
    {
      key: "salescrm",
      name: "Sales Numa",
      ...
      href: "sales-crm.html",
      color: "#2563eb",
      specialty: "Rep territory, contracts, daily sales priorities, account touches, and sync back to Atlas.",
      canDo: ["Prioritize today's account work", "Suggest the next relationship touch", "Help update contracts without losing Atlas context"],
      prompt: "Owns the sales-rep relationship link. Keep the rep focused on their territory, contracts, contacts, and daily follow-up list while preserving updates for Atlas.",
    },
    {
      key: "meet",
      name: "Numa",
      ...
      href: "meet.html",
      color: "#be2633",
      specialty: "Meeting recordings, summaries, action items, and Atlas or profile handoff.",
      canDo: ["Summarize meeting notes", "Extract action items", "Push useful signals to Atlas or profile work"],
    ...
    },
    {
      ...
      canDo: ["Prepare interview invite text", "Check selected candidate and job context", "Route follow-up to Meet or Atlas"],
